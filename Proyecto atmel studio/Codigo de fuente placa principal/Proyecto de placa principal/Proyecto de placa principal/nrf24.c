...
uint8_t MOTORIZED_BOARD_ADDR[5] =	{0xF0,0xF0,0xF0,0xF0,0xC9};
uint8_t MAIN_BOARD_ADDR[5] =			{0xA4,0xA4,0xA4,0xA4,0xA4};
uint8_t POWER_BOARD_ADDR[5] =		{0xF0,0xF0,0xF0,0xF0,0xF0};
	
uint8_t NULL_ADDR[5] =		{0x00,0x00,0x00,0x00,0x00};

uint8_t* BOARD_ADDRESS[3] = {&MAIN_BOARD_ADDR[0], &POWER_BOARD_ADDR[0], &MOTORIZED_BOARD_ADDR[0]};
uint8_t* CURRENT_BOARD_ADDRESS = &MAIN_BOARD_ADDR[0];
...
/* Set the secondary RX address */
void nrf24_secondary_rx_address(uint8_t * adr)
{
	nrf24_ce_digitalWrite(LOW);
	nrf24_writeRegister(RX_ADDR_P2,adr,1);	// One byte long
	nrf24_ce_digitalWrite(HIGH);
}
