...
uint8_t* CURRENT_BOARD_ADDRESS = &POWER_BOARD_ADDR[0];
...
#define CE_CSN_DDR  DDRC
#define CE_CSN_PORT PORTC
#define CE_CSN_PIN  PINC

#define MISO_BIT_POS	0
#define MOSI_BIT_POS	1
#define SCK_BIT_POS		4

#define CE_BIT_POS		0
#define CSN_BIT_POS		1
