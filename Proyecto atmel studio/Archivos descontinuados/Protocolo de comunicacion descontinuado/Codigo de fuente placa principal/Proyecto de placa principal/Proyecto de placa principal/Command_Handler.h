...
extern void UART_TEST_HANDLER(), BUILT_IN_LED_TEST_HANDLER(), TURN_EVERYTHING_ON_HANDLE(), TURN_EVERYTHING_OFF_HANDLE(), CALL_NURSE_HANDLE();
extern void CURTAIN_POS_CHANGE_HANDLE(), STRETCHER_POS_CHANGE_HANDLE();

extern void RETRANSMISSION_TO_BOARD(uint8_t board, const commandType* targetType);
